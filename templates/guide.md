...
<center><img src="{{ url_for('img', path='/mypackage_flow.png') }}" style="max-width: 800px" /></center>
...
<center><img src="{{ url_for('img', path='/custom_widgets_example.png') }}" style="max-width: 800px" /></center>
